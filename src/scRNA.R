...
obj <- SCTransform(obj)
obj <- ScaleData(obj, freature = rownames(obj)) # important to scale
...
ggsave(filename = 'CD4_CD8_expression.pdf')
DoHeatmap(obj, features = c('CD3E', 'CD4', 'CD8A'))
ggsave(filename = 'CD4_CD8_expression_heatmap.pdf')
